...
contents.forEach((content)=>{
    contentTexts.push([
        ...content.querySelectorAll(".oh > span")
    ]);
});
...
const openContent = (image, position)=>{
    ...
    (0, _gsap.gsap).timeline({
        ...
        // Get state
        const state = (0, _flip.Flip).getState(image);
        // Change place
        ...
        (0, _gsap.gsap).set(contentBackCtrls[position], {
            xPercent: 20,
            opacity: 0
        });
        // hide text spans
        (0, _gsap.gsap).set(contentTexts[position], {
            yPercent: 101
        });
    }, "start").to([
        introTexts,
    ...
    }, "start").addLabel("content", "start+=0.7").to(contentTexts[position], {
        ease: "expo",
        yPercent: 0
    }, "content").to(contentBackCtrls[position], {
        ease: "expo",
        xPercent: 0,
        opacity: 1
    }, "content");
...
const closeContent = (image, position)=>{
    ...
    }).addLabel("start", 0).to(contentTexts[position], {
        duration: 0.8,
        yPercent: 101
    }, "start").to(contentBackCtrls[position], {
        duration: 0.8,
        xPercent: 20,
        opacity: 0
    }, "start").add(()=>{
    ...
    }, "start").addLabel("intro", "start+=0.6").to([
        introTexts,
        otherImages
    ], {
        ease: "expo",
...
new (0, _cursor.Cursor)(document.querySelectorAll(".cursor"), "a, .intro > .image, .content__back");
// Preload images and fonts and remove loader
Promise.all([
    (0, _utils.preloadImages)(".image__inner")
]).then(()=>setTimeout(()=>{
        document.body.classList.remove("loading");
    }, 1000));

},{"./cursor":"3v1v0","gsap":"fPSuC","gsap/Flip":"iKp6p","./utils":"72Dku"}],"3v1v0":[function(require,module,exports) {
...
class Cursor {
   ...
   */ constructor(Dom_elems, triggerSelector = "a"){
        ...
        [
            ...this.DOM.elements
        ].forEach((el)=>this.cursorElements.push(new CursorElement(el)));
        [
 ...
 */ class CursorElement {
   ...
   */ leave() {
    ...
    createFilterTimeline() {
        this.filterTimeline = (0, _gsap.gsap).timeline({
            paused: true,
            onStart: ()=>{
...
const imagesLoaded = require("8b19df42a56bf7d6");
/**
 * Preload fonts
 * @param {String} id
...
},{"8b19df42a56bf7d6":"aYzyZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aYzyZ":[function(require,module,exports) {
/*!
 * imagesLoaded v5.0.0
 ...
 */ (function(window1, factory) {
    ...
    module.exports = factory(window1, require("29794452407833fd"));
    else // browser global
...
},{"29794452407833fd":"7rCHo"}],"7rCHo":[function(require,module,exports) {
/**
 * EvEmitter v2.1.1
 * Lil' event emitter
 * MIT License
...
},{}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire2e85")
